...
Beispiel: Send payload: ON oder OFF an topic "switch/pin" - um die Beleuchtung eons- oder auszuschalten
...
* WiFi.localIP - z.B. 192.168.1 123
* swRev - z.B. 3.4
* hwRev - z.B. 2.0
...
void reconnect()
{
  while (!client.connected())
  {
    ...
    if (client.connect("ESP8265Client", mqtt_user, mqtt_password, mqtt_topic_info_status, 1, true, "offline"))
    {
